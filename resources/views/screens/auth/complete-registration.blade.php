...
@section('content')
    <div class="mt-10">
        <div class="px-3 py-8 w-4/5 m-auto bg-on-surface-color rounded-lg">
            ...
            <form class="w-4/5 m-auto mt-8 flex flex-col gap-4" action="{{ route('complete-registration') }}"
                  method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="flex flex-row gap-2 w-full">
                            <div class="w-full">
                                ...
                                <input type="text" id="firstname" name="firstname"
                                       class="text-text-color rounded-md p-2 bg-primary-color w-full" required>
                            </div>
                            <div class="w-full">
